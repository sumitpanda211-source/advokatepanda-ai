    ...
    <main className="min-h-screen bg-gray-950 text-white p-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-blue-400">⚖️ AdvokateAI Panda</h1>
          ...
          <div className="flex flex-col gap-4">
            ...
            {!generatedDoc ? (
              <div className="bg-gray-900 rounded-2xl p-6">
                <p className="text-gray-400 text-sm mb-4">Fill in the details below to generate your document</p>
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          For educational purposes only. Always consult a qualified lawyer. © AdvokateAI Panda
        </p>
      </div>
    </main>
  );
